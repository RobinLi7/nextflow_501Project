...
# seurat_file <- "/projects/rli_prj/CPSC501/project/work/a2/3dd46b4fa3ac8b1c2288d28973b1d0/seurat_obj.rds"
# output_dir <- "."
...
new_cluster_ids <- c("T cells", "Monocytes/Neutrophils", "B cells", "NK cells", "Uncertain")
